...
object ActionI18nIcons {
    ...
    @JvmField val I18N = IconManager.getInstance().getIcon("/io/nimbly/i18n/icons/g_trans.png", javaClass.classLoader)
    @JvmField val SWAP = IconManager.getInstance().getIcon("/io/nimbly/i18n/icons/swap.svg", javaClass.classLoader)
